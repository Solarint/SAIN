...
{
    public class GroupTalk : SAINTalk
    {
        ...
        private void GetMemberDecisions()
        {
            ...
            foreach (var member in BotSquad.SquadMembers)
            {
                var decision = member?.GetComponent<SAINComponent>()?.CurrentDecision;
                if (decision != null)
                {
            ...
            GroupDecisions.AddRange(decisions);
        }
        ...
        {
            var decision = SAINLayers.CurrentDecision;
            mask = ETagStatus.Combat;
        ...
        public bool CheckIfLeaderShouldCommand()
        {
            ...
            if (CommandSayTimer < Time.time)
            {
                ...
                else if (SAINLayers.CurrentDecision == SAINLogicDecision.Search)
                {
                ...
                else if (SAINLayers.CurrentDecision == SAINLogicDecision.RunAway)
                {
