...
{
    public class EnemyClass : SAINBase, ISAINClass
    {
        public EnemyClass(SAINComponentClass bot, IAIDetails person) : base(bot)
        {
            Person = person;
        ...
        public Vector3 Direction => (Person != null ? CurrPosition - SAIN.Transform.Position : Vector3.zero);
    ...
    {
        public SAINEnemyVision(EnemyClass enemy) : base(enemy) { }
    ...
    {
        public SAINEnemyPath(EnemyClass enemy) : base(enemy) { }
    ...
    {
        public SAINEnemyStatus(EnemyClass enemy) : base(enemy) { }
    ...
    {
        public SAINEnemyAbstract(EnemyClass enemy)
        {
            Enemy = enemy;
        }
