...
namespace SAIN.Components
{
    public class LeanComponent : MonoBehaviour
    {
        ...
        {
            Lean = new BotLean(bot);
            SideStep = new BotSideStep(bot);
            BlindFire = new BotBlindFire(bot);
        ...
        private void Update()
        {
            if (BotOwner.BotState == EBotState.Active && !BotOwner.IsDead && TargetPosition != null)
            {
        ...
        public class BotLean : SAIN.SAINBot
        {
        ...
        public class BotSideStep : SAIN.SAINBot
        {
        ...
        public class BotBlindFire : SAIN.SAINBot
        {
