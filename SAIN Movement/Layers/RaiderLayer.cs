...
{
    internal class RaiderLayer : CustomLayer
    {
        public RaiderLayer(BotOwner bot, int priority) : base(bot, priority)
        {
            Logger = BepInEx.Logging.Logger.CreateLogSource(GetType().Name);
            Logger.LogInfo($"Added SAIN Raider Layer to {bot.name}");
